...
class DataModelTest(unittest.TestCase):
    ...
    def test_all_required_signals_present(self):
        required={'grid_voltage_l1','grid_voltage_l2','grid_voltage_l3','grid_current_l1','grid_current_l2','grid_current_l3','grid_power_l1','grid_power_l2','grid_power_l3','grid_frequency','input_power','dc_link_voltage','output_voltage','output_current','output_power','earth_voltage','temp_pfc','temp_dab_primary','temp_dab_secondary','temp_pcb_primary','temp_pcb_secondary','temp_inductor','temp_transformer'}
